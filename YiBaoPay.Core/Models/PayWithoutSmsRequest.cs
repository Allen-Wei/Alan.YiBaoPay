...
namespace YiBaoPay.Core.Models
{
    ...
    /// 无需短验支付请求参数
    /// </summary>
    public class PayWithoutSmsRequest : BaseRequestIdentityCard, IBaseRequest<PayWithoutSmsResponse>
    {
        /// <summary>
        /// 商户订单号
        /// </summary>
        ...
        /// </summary>
        public string Currency { get { return "156"; } }
        /// <summary>
        /// 交易金额
        /// </summary>
        ...
        public  Tuple<bool, string, PayWithoutSmsResponse> Send()
        {
            var api = new PayWithoutSms();
            var svrRep = api.Send(this);
            if (!svrRep.IsSuccess) return Tuple.Create(false, svrRep.Error_Msg, default(PayWithoutSmsResponse));
